let nameData = {
    ...
    lastName: "sahu",
    // if you want to pass the parameter you can add when you will that method you have to add after comma into that
...
// nameData.fullName.call(anotherNameData, "software enggg", 24)
// call methods
